...
safe_repair(_, _, diagnostic(nix, undefined_attribute, "swiProlog"),
            backend_package(nix, swi_prolog, "swi-prolog")).
safe_repair(_, _, diagnostic(nix, missing_attribute, "swiProlog"),
            backend_package(nix, swi_prolog, "swi-prolog")).
safe_repair(_, _, diagnostic(nix, undefined_attribute, "nixfmt-rfc-style"),
            backend_package(nix, nixfmt, "nixfmt")).
safe_repair(_, _, diagnostic(guix, unknown_package, "swipl"),
